...
describe 'form_generator' do
  ...
  it 'should generate an input field' do
    assert_equal '<input value="rob" />', FormGenerator.form_for(user).input(:name).to_s
  end

  it 'should generate a text area' do
    assert_equal '<textarea value="rob"></textarea>', FormGenerator.form_for(user).input(:name, as: :text).to_s
  end
  ...
  it 'should generate a form with input' do
    ...
    assert_equal '<form action="#" method="post"><input value="rob" /></form>', result
  end
  ...
  it 'should generate a form with multiple inputs' do
    ...
    assert_equal '<form action="#" method="post"><input value="rob" /><input value="developer" /></form>', result.to_s
  end
  it 'should generate a form with multiple inputs and textarea' do
    ...
    assert_equal '<form action="#" method="post"><input value="rob" /><textarea value="developer"></textarea></form>',
                 result.to_s
  end
  it 'should add attributes to inputs' do
    ...
    assert_equal '<form action="#" method="post"><input class="input" value="rob" /><textarea class="textarea" value="developer"></textarea></form>',
                 result.to_s
  end
